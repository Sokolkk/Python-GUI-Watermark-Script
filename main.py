...
class WatermarkApp:
    def __init__(self, root):
        ...
        self.opacity = tk.IntVar(value=self.load_setting("opacity", 90)) # В процентах 0-100
        self.radius = tk.IntVar(value=self.load_setting("radius", 74))   # В процентах 0-100
        self.scale = tk.IntVar(value=self.load_setting("scale", 12))     # Размер в процентах 1-100
    ...
    def load_setting(self, key, default):
        """Загружает настройку из JSON файла."""
    ...
    def save_all_settings(self):
        """Сохраняет все текущие настройки в JSON файл."""
        settings = {
    ...
    def setup_ui(self):
        ...
        tk.Button(frame_output, text="Изменить папку", command=self.choose_output_folder).pack(side="right")
    ...
    def process_images(self):
        ...
        # Перед началом работы сохраняем все настройки
        self.save_all_settings()
